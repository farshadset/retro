...
test.describe('Home actions and profile registration', () => {
  test('online button opens online game and profile registration validates uniqueness', async ({ page, context }) => {
    ...
    await secondPage.getByTestId('profile-save-btn').click()
